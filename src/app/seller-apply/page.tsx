        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-24 sm:pb-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border border-gray-300 px-3 py-2.5 text-sm bg-white focus:outline-none focus:border-black focus:ring-1 focus:ring-black"
                            >
                    ...
                    <p className="mt-2 text-xs text-gray-400">
                        Your ID details are kept private and used only to verify your identity. They will not be shown publicly.
                    </p>
                </section>
