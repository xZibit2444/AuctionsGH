...
export default function LoginForm({ urlError, redirectTo = '/', verified }: LoginFormProps) {
    ...
    return (
        <div className="space-y-6">
            {verified === '1' && !urlErrorMessage && !error && (
                <div className="flex items-center gap-2 border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-sm text-emerald-700">
                    <CheckCircle2 className="h-4 w-4 shrink-0" />
                    Email verified. You can sign in now.
                </div>
            )}
            {(urlErrorMessage || error) && (
                <div className="flex items-center gap-2 border border-amber-200 bg-amber-50 px-3 py-2.5 text-sm text-amber-700">
